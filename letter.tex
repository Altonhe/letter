...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.55\textwidth]{background.png}};
    \end{tikzpicture}
\vfill}}}
...
\def\URL{\textbf{\color{hdublue}URL}: \url{https://faculty.hdu.edu.cn/wlkjaqxy/xxx/main.htm}}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
% NOTE: Actually I don't think here's right place to set the footer. You'd better try it in hduletter.cls (from He)
